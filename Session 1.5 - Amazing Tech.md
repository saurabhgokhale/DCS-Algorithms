...
>Do you know how Chat GPT works
```
Transformers are a type of Neural Network in Machine Learning Models.
...
Some take text and generate an image
```
...
## ChatGPT
[![ChatGPT](https://img.youtube.com/vi/wjZofJX0v4M/0.jpg)](https://youtu.be/wjZofJX0v4M?t=73 "How ChatGPT Works")
...
However, once you have a prediction model like this, you can feed the same prediction data back to the model to generate the next text.
```
...
## Embedding
```
The initial text is broken down into smaller chunks called Tokens
```
...
```
These sequences of vectors are then passed through a phase called the Attention Block. 
